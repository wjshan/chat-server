...
# WARNING: Ensure imports from `chat_server` comes after this line
from chat_server import app, settings, db  # noqa
from chat_server.cli import create_user, cli  # noqa
