...
from chat_server.serializers.public_serializer import BaseResponseSerializer
...
app = FastAPI(
    title="chat_server",
    description="chat_server API helps you do awesome stuff. 🚀",
    version=read("VERSION"),
    terms_of_service="http://chat_server.com/terms/",
